...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-950 via-slate-900 to-black overflow-hidden py-12 md:py-20">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-8 lg:px-10 flex flex-col items-center text-center">

        {/* Status Badge */}
        <div className="mb-8 flex items-center gap-3 px-5 py-2 bg-white/5 border border-white/10 rounded-full backdrop-blur-md animate-fade-in">
          ...
          <span className="text-xs uppercase tracking-widest font-semibold text-gray-400">
            System Online // v24.0.0
          </span>
        </div>

        {/* Main Hero Box */}
        <div className="w-full bg-white/5 backdrop-blur-2xl border border-white/10 p-8 sm:p-12 md:p-16 rounded-[2rem] md:rounded-[3rem] shadow-[0_20px_60px_rgba(0,255,200,0.15)] hover:shadow-[0_25px_80px_rgba(0,255,200,0.25)] transition-all duration-700 group">
          
          <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tighter mb-4 md:mb-6 text-white">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-lime-400 mb-6 uppercase tracking-wide">
            Full-Stack Developer & DevOps Aspirant
          </h2>

          <p className="text-sm sm:text-lg md:text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-8">
            <span className="text-white font-bold">Self-taught dev</span> obsessed with React, automation, and clean architecture. 
            I craft apps people love, from habit trackers to Linux dev environments, 
            focusing on <span className="text-lime-400 font-bold">real-time progress & sleek design.</span>
          </p>

          {/* Skills / Stats */}
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 pt-6 md:pt-10 border-t border-white/10">
            {[
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 md:gap-8 mt-8">
          <a
            href="#projects"
            onClick={scrollToProjects}
            className="group relative w-full sm:w-auto px-10 py-4 bg-lime-400 text-black font-bold rounded-2xl shadow-[0_0_25px_rgba(163,230,53,0.35)] hover:scale-105 transition-transform flex items-center justify-center gap-2 overflow-hidden"
          >
            Launch Projects
          ...
          <a
            ...
            download
            className="group relative w-full sm:w-auto px-10 py-4 bg-white/5 backdrop-blur-md border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 hover:border-blue-500/50 transition-all flex items-center justify-center gap-3 overflow-hidden"
          >
            ...
            <Download size={22} className="text-blue-400 group-hover:animate-bounce" />
            Fetch Curriculum Vitae
          </a>
        </div>
